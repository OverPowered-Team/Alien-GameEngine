...
void PanelInspector::ButtonAddComponent()
{
	...
	if (component == (uint)ComponentType::SCRIPT) { 
		...
		ImGui::Combo("##choose component", &component, "Select Component\0Mesh\0Material\0Light\0Camera\0Canvas\0Image\0Button\0Checkbox\0Script\0"); // SCRIPT MUST BE THE LAST ONE
