...
void GameObject::SetDrawList(std::vector<std::pair<float, GameObject*>>* to_draw, std::vector<GameObject*>* to_draw_ui, const ComponentCamera* camera)
{
