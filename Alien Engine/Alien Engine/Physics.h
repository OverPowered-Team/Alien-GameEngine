...
public:
	...
	static bool								  Raycast(float3 origin, float3 unit_dir, float max_dist, int layer_mask = -1); // TODO: make own pxraycastbuffer data to abstract from physx
	static bool								  Raycast(float3 origin, float3 unit_dir, float max_dist, RaycastHit& hit, int layer_mask = -1); // TODO: make own pxraycastbuffer data to abstract from physx
